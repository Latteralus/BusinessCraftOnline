...
export type SharedManufacturingStatus = (typeof MANUFACTURING_STATUSES)[number];
...
export type SharedManufacturingBusinessType = (typeof MANUFACTURING_BUSINESS_TYPES)[number];

export type SharedManufacturingRecipe = {
  key: string;
  businessType: SharedManufacturingBusinessType;
  displayName: string;
  skillKey: string;
...
] as const satisfies readonly SharedManufacturingRecipe[];
