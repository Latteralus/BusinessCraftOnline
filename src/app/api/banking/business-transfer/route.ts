...
export async function POST(request: Request) {
  ...
  const parsed = transferBetweenPersonalAndBusinessSchema.safeParse(payload);
  ...
  try {
    const result = await transferBetweenPersonalAndBusiness(supabase, user.id, parsed.data);
