...
import {
  EXTRACTION_BASE_OUTPUT_PER_TICK_BY_BUSINESS as SHARED_EXTRACTION_BASE_OUTPUT_PER_TICK_BY_BUSINESS,
  ...
  EXTRACTION_TOOL_OUTPUT_BONUS_BY_BUSINESS as SHARED_EXTRACTION_TOOL_OUTPUT_BONUS_BY_BUSINESS,
...
export const EXTRACTION_BASE_OUTPUT_PER_TICK_BY_BUSINESS: Record<ExtractionBusinessType, number> =
  SHARED_EXTRACTION_BASE_OUTPUT_PER_TICK_BY_BUSINESS;
...
export const EXTRACTION_TOOL_OUTPUT_BONUS_BY_BUSINESS: Partial<Record<ExtractionBusinessType, number>> =
  SHARED_EXTRACTION_TOOL_OUTPUT_BONUS_BY_BUSINESS;
