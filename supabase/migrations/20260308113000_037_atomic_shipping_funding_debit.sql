-- Phase 20 patch: debit shipping costs atomically during inventory transfer.
-- Adds a dedicated transaction type and requires a funding account for cross-city shipping.
