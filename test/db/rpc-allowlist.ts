...
export const AUTHENTICATED_ALLOWED_FUNCTIONS = [
  ...
  "award_government_contract_atomic",
...
export const SERVER_ONLY_SECURITY_DEFINER_FUNCTIONS = [
  ...
  "create_replenishment_contracts_for_due_stockpiles",
  "deliver_government_contract_atomic",
  ...
  "materialize_and_replenish_city_stockpiles_due",
